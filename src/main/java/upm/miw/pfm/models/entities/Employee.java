...
public class Employee {
	...
	public Employee(String name, String surname, String employeeCode,
			Double annualGrossSalary, Contract contract, Set<RoleType> roles) {
		this.name = name;
	...
	public int hashCode() {
		...
		result = prime
				* result
				+ ((annualGrossSalary == null) ? 0 : annualGrossSalary
						.hashCode());
		result = prime * result
	...
	public String toString() {
		return "[Name=" + name + ", surname=" + surname + ", employeeCode="
				+ employeeCode + ", annualGrossSalary=" + annualGrossSalary
	...
	public boolean equals(Object obj) {
		...
		return id == other.id
				...
				&& annualGrossSalary.doubleValue() == other.annualGrossSalary
						.doubleValue() && contract.equals(other.contract)
