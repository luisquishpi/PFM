...
public class HolidayDaoHibernate extends GenericDaoHibernate<Holiday, Integer> implements
        HolidayDao {
    ...
    public Boolean exists(Holiday entity) {
        ...
        try {
            ...
            Query query = session
                    .createQuery("from Holiday h WHERE h.start = :start AND h.end = :endDate ");
